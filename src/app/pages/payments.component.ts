  ...
  template: `
    <div class="page-container animate-up">
      ...
      <div class="action-bar-glass mt-32 animate-up delay-2">
        ...
        <div class="search-premium" *ngIf="activeTab === 'history'">
      ...
      <div class="content-card-premium animate-up delay-3">
        <div [ngSwitch]="activeTab">
          ...
          <div *ngSwitchCase="'pending'" class="p-32">
            <div *ngIf="pendingPayments().length === 0" class="notif-empty" style="padding: 100px 0;">
            ...
            <div class="elite-payment-grid">
              <div *ngFor="let item of pendingPayments()" class="elite-payment-item animate-scale">
          ...
          <div *ngSwitchCase="'history'">
             <div class="table-responsive-elite">
                <table class="modern-table-elite">
                  ...
                  <tbody>
                    <tr *ngFor="let p of filteredPayments()" class="table-row-hover">
                      ...
                      <td>
                        <div class="status-pill-elite" [ngClass]="p.status">
                           <span class="dot"></span>
                           {{ p.status }}
                        </div>
                      </td>
