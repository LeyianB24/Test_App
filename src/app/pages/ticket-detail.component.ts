...
@Component({
  ...
  template: `
    <div class="container mx-auto p-4 md:p-8">
      ...
      <!-- Ticket Content -->
      <div *ngIf="ticket && !helpdeskService.isLoading()" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- Main Content -->
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-lg border border-gray-200 shadow p-6">
            ...
            <div class="flex flex-wrap gap-3 mb-6">
              <span [ngClass]="getStatusClass(ticket.status)" class="px-4 py-2 rounded-full text-sm font-semibold">
                {{ ticket.status }}
              </span>
              <span [ngClass]="getPriorityClass(ticket.priority)" class="px-4 py-2 rounded-full text-sm font-semibold">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-200">
              ...
              <div *ngIf="ticket.first_response_at">
          ...
          <div class="bg-white rounded-lg border border-gray-200 shadow p-6">
            ...
            <div class="space-y-4 mb-6 max-h-96 overflow-y-auto">
              <div *ngIf="!ticket.replies || ticket.replies.length === 0" class="text-center py-8 text-gray-500">
                No replies yet
              </div>
              <div *ngFor="let reply of ticket.replies" class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div class="flex justify-between items-start mb-2">
                  <p class="font-medium text-gray-900">Reply #{{ reply.id }}</p>
                  <span *ngIf="reply.is_internal" class="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded">
                    Internal Note
                  </span>
                </div>
          ...
          <!-- Attachments Section -->
          <div *ngIf="ticket.attachments && ticket.attachments.length > 0" class="bg-white rounded-lg border border-gray-200 shadow p-6">
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-lg border border-gray-200 shadow p-6">
            ...
            <div class="space-y-2">
              ...
              <button
                ...
                *ngIf="!['Resolved', 'Closed'].includes(ticket.status)"
              ...
              <button
                ...
                *ngIf="ticket.status !== 'Waiting for Customer'"
          ...
          <!-- SLA Info -->
          <div class="bg-white rounded-lg border border-gray-200 shadow p-6" *ngIf="slaInfo">
          ...
          <!-- History -->
          <div *ngIf="ticket.history && ticket.history.length > 0" class="bg-white rounded-lg border border-gray-200 shadow p-6">
            <h3 class="text-lg font-bold text-gray-900 mb-4">History</h3>
            <div class="space-y-3 text-sm max-h-64 overflow-y-auto">
              <div *ngFor="let event of ticket.history" class="pb-3 border-b border-gray-200 last:border-b-0">
