...
export class DebtComponent {
  ...
  debts = signal<any[]>([
    { id: 1, taxHead: 'Income Tax - Resident Individual', period: '2023 FY', principal: 45000, interest: 4500, penalty: 2250 },
    { id: 2, taxHead: 'Value Added Tax (VAT) Hub', period: 'DEC 2023', principal: 12000, interest: 1200, penalty: 600 },
    { id: 3, taxHead: 'Turnover Tax Registry', period: 'Q4 2023', principal: 3500, interest: 350, penalty: 0 }
  ]);
