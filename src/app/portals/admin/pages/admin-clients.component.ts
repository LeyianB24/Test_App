            ...
            @if (!loading() && !error()) {
               ...
               @if (clients().length === 0) {
                 <div class="flex flex-col items-center justify-center py-40 animate-scale">
                    ...
                    <h3 class="text-xl font-black text-slate-800 mb-2">No Taxpayers Found</h3>
                    <p class="text-slate-400 font-bold uppercase tracking-widest text-[10px] mb-8">No records match your search criteria</p>
