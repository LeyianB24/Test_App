  ...
  template: `
    <div class="page-container p-8 animate-fade-in">
      <header class="mb-12 flex justify-between items-end">
        <div>
          <h1 class="text-5xl font-black text-white tracking-tighter mb-2">My <span class="text-red-500">Notifications</span></h1>
          <p class="text-slate-400 font-medium text-lg">View all your alerts and updates.</p>
        </div>
      ...
      <div class="max-w-4xl mx-auto space-y-4">
        @for (n of ns.notifications(); track n.id) {
          ...
          <div class="py-32 text-center animate-fade-in">
             ...
             <h3 class="text-3xl font-black text-white tracking-tighter mb-2">No Notifications</h3>
